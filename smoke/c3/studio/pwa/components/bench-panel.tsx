  ...
  return (
    <section className="grid flex-1 gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
      ...
      <aside className="flex flex-col gap-3">
        ...
        <Card className="border-amber-300/12 bg-amber-300/[0.035] ring-0"><CardContent className="p-4"><div className="mb-2 flex items-center gap-2 text-sm font-medium text-amber-200"><ShieldAlert className="size-4" /> Measurement boundary</div><p className="text-xs leading-5 text-amber-100/60">This measures the exported ONNX model on this browser. It does not measure detection accuracy, training speed, device temperature, or operator-level CPU/GPU placement.</p></CardContent></Card>
