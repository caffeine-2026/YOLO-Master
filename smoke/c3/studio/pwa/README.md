...
- **Live** — camera frames, one inference in flight, detection overlay, FPS and stage timing
- **Photo** — up to nine local images, sequential inference, result selection and JSON export
